 ...
 */
export async function sendEmergencyAlert(toPhoneNumber, messageBody) {
    if (!client || !fromNumber) {
        console.log("[Twilio] Skipped — set TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, and TWILIO_PHONE_NUMBER in .env");
        return null;
    }
    try {
